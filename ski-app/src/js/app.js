...
//
//       // const countryName = countryCodes[resort.country];
//
//       // console.log(resort.country);
//       $('.dropdown-menu').append(`<li><a href="#" class="filter" value="codes[0]">codes[0]</a></li>`);
//       $('.filter').on('click', googleMap.selectCountry);
  ...
  $.get('http://localhost:3000/api/resorts').done(data => {
    ...
    if ($country){
      ...
      data = data.filter(function(resort){
        ...
        // console.log('resort', resort.country, $country)
